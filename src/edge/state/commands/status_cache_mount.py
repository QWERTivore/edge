...
def run() -> MountReport:
  """
  Loads the cache key of the mount mapping from startup/config.startup.yml and
  ...
  path_exists = os.path.exists(mount.cache)
  is_mounted = os.path.ismount(mount.cache)
